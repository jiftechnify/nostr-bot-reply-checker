...
const msg = {
  ...
  replyWithoutRefAndETag:
    "・ 😶本文にリプライ先ユーザへの参照が含まれていないようです。特定の投稿を対象としないリプライの場合は、NIP-27に従って参照を含めることでリプライ対象のユーザを明示することをおすすめします。なお、eタグを設定したにもかかわらずこのメッセージが表示されている場合は、イベントIDが間違っている可能性があります",
